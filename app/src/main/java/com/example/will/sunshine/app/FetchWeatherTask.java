...
//        weatherDataList = Arrays.asList(weatherData);
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Log.v(LOG_TAG, "Weather url: " + weatherUri.toString());
//            http://api.openweathermap.org/data/2.5/weather?q=London,uk&mode=json&units=metric&cnt=7
//            http://api.openweathermap.org/data/2.5/weather?lat=51.56&lon=-0.06
